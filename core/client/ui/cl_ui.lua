            ...
            {
                {
                    ...
                    items = 
                    {
                        ...
                        {name = "w_kf", type_1 = "normal", label_1 = "Wheel Kamber Front", sliderItems_1 = {}, type_2 = "slider", label_2 = "", sliderItems_2 = slider6, sliderStartPos = startPos[6]},
                        {name = "w_kr", type_1 = "normal", label_1 = "Wheel Kamber Rear", sliderItems_1 = {}, type_2 = "slider", label_2 = "", sliderItems_2 = slider7, sliderStartPos = startPos[6]}
                    }
                },
                {
